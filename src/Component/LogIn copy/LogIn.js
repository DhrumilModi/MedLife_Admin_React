      ...
      <div className="Login">
        ...
        <form onSubmit={this.handleSubmit} className={this.state.form}>
        {
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" style={{borderColor:this.state.input1}}id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email"  value={this.state.username} onChange={this.handleUserChange}></input>
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Password</label>
                <input type="password" class="form-control " style={{borderColor:this.state.input2}} id="exampleInputPassword1" placeholder="Password" value={this.state.password} onChange={this.handlePassChange} />
            </div>
